                  ...
                  {isAdmin && pendingPosts.length > 0 && (
                    <div className="mb-6">
                      ...
                      {pendingPosts.map((post) => (
                        <div
                          key={post.id}
                          className="flex bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4 hover:shadow-md transition-shadow duration-200"
                        >
                  ...
                  <div className="space-y-4">
                    {posts
                      ...
                      .map((post) => (
                        <div
                          key={post.id}
                          className="flex bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow duration-200 group"
                        >
                          <div className="flex-1 pr-4">
