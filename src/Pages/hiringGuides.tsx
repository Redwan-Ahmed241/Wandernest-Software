  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 mb-6">
      ...
      <div className="flex gap-4 mt-2">
        <button
          className={`flex items-center gap-1 px-3 py-1 rounded-lg border border-border ${
            liked
        ...
        <div className="max-w-3xl mx-auto py-10 px-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-primary-dark text-base">
                  Sundarban Wildlife Guide
                </p>
              </div>
            </div>
            <button
              className="px-6 py-2 rounded-lg bg-primary text-white font-semibold hover:bg-primary-dark transition mt-4 md:mt-0"
              onClick={handleHire}
            >
              Hire Now
            </button>
          ...
          <div className="mb-8">
            ...
            <p className="text-primary-dark text-sm mb-4">
              Nadir is a certified Sundarban wildlife guide with over a decade
              of experience. Specializing in tiger tracking and bird watching,
              he has extensive knowledge of the mangrove ecosystem. Fluent in
              English, Bengali, and Hindi, Nadir provides engaging and
              informative tours that connect visitors with nature.
            </p>
              ...
              num === "..." ? (
                ...
                <span
                  ...
                  className={`px-3 py-1 rounded-lg cursor-pointer text-sm font-semibold ${
                    num === currentPage
                      ? "bg-primary text-white"
                      : "bg-accent-light text-primary-dark hover:bg-primary-light"
                  }`}
