    ...
    <div className="min-h-screen bg-white py-12 px-4 mt-16">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-700 text-base mb-4 text-center">
          This Cookie Policy explains how WanderNest uses cookies and similar
        ...
        <section>
          ...
          <p className="text-gray-600 mb-4">
            ...
            preferences, analyze site traffic, and deliver personalized content
            and ads.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="text-gray-600 mb-4">
            ...
            cookies are being sent. If you disable cookies, some features of our
