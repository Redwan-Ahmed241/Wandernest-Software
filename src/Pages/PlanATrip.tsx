        ...
        <div className="w-full max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8 flex flex-col gap-8">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-lg text-theme-secondary">
              Select your travel dates and explore recommended activities!
            </p>
          </div>
            ...
            <main className="flex-1">
              ...
              <section className="flex flex-col md:flex-row gap-8 mb-8">
                ...
                <div className="bg-theme-light rounded-xl shadow p-6 flex flex-col items-center min-w-[320px] max-w-[400px] flex-1">
                  <h3 className="font-bold text-xl text-theme-primary mb-4">
                    Select Your Dates
                  </h3>
                  <div className="grid grid-cols-7 gap-2 w-full">
                    ...
                    {daysArray.map((day) => (
                      <span
                        key={day}
                        className={`cursor-pointer px-3 py-2 rounded-lg text-theme-primary font-semibold transition-all duration-150 ${
                          selectedDay === day
                            ? "bg-theme-accent text-white"
                            : "bg-theme-bg hover:bg-theme-accent/20"
                        }`}
                ...
                <div className="min-w-[320px] flex-1 max-w-[400px]">
                  ...
                  <button className="mt-7 w-full bg-theme-accent text-white rounded-xl font-bold text-lg py-3 shadow transition-colors duration-200 hover:bg-theme-accent-dark">
                    Go for it!
                  </button>
                </div>
              </section>
