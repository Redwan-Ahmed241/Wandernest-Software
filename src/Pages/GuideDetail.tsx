    ...
    const fetchGuideDetails = async () => {
      ...
      try {
        ...
        const safeGuide = {
          ...
          image:
            guideData?.image ||
            guideData?.profile_picture ||
            "/Figma_photos/1a.jpeg",
          profile_picture:
            guideData?.profile_picture ||
            guideData?.image ||
            "/Figma_photos/1a.jpeg",
          ...
          languages: Array.isArray(guideData?.languages)
            ? guideData.languages
            : [],
          specialties: Array.isArray(guideData?.specialties)
            ? guideData.specialties
            : [],
          certifications: Array.isArray(guideData?.certifications)
            ? guideData.certifications
            : [],
          services_offered: Array.isArray(guideData?.services_offered)
            ? guideData.services_offered
            : [],
          services: Array.isArray(guideData?.services)
            ? guideData.services
            : [],
          contact_info: guideData?.contact_info || {},
          availability: guideData?.availability || false,
          availability_status:
            guideData?.availability_status ||
            (guideData?.availability ? "Available" : "Busy"),
        };
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-green-50 rounded-xl">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  {form.days} day{form.days > 1 ? "s" : ""} × ৳{guide?.price}{" "}
                  per day
                </p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
            <div className="md:flex">
              ...
              <div className="md:w-1/3">
                <img
                  src={
                    guide.profile_picture?.startsWith("https://example.com") ||
              ...
              <div className="md:w-2/3 p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-gray-600">
                    <Award size={16} />
                    <span>
                      {(guide?.certifications || []).length} certifications
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {(guide.services_offered || guide.services || []).map(
                        (service, index) => (
