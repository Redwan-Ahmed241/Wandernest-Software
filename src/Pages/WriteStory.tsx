    ...
    try {
      ...
      if (imageFile && imageUploadMethod === "file") {
        ...
        formDataToSend.append(
          "excerpt",
          formData.excerpt.trim() || formData.content.substring(0, 200) + "..."
        );
      ...
      if (!response.ok) {
        ...
        if (response.status === 401) {
          ...
          const errorMessages = Object.values(responseData.errors || {})
            ...
            .join(", ");
          throw new Error(
            errorMessages || responseData.message || "Validation error"
          );
        } else if (response.status === 429) {
          throw new Error(
            "You have reached the daily limit of 5 blog posts. Please try again tomorrow."
          );
        } else if (response.status === 413) {
          throw new Error(
            "Your story is too long. Please reduce the content size."
          );
        } else {
      ...
      alert(
        `🎉 Success! Your story "${formData.title}" has been submitted for review. You'll be notified once it's approved for publication.`
      );
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">
                Tell fellow travelers about your amazing experiences and
                discoveries
              </p>
            </div>
          ...
          >
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>
                  • Share authentic travel experiences from Bangladesh or other
                  destinations
                </li>
                <li>
                  • Include helpful tips and insights for fellow travelers
                </li>
                <li>
                  • Use respectful language and be mindful of cultural
                  sensitivities
                </li>
